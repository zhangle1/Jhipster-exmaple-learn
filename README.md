...
To optimize the ablog application for production, run:
...
[Doing API-First development]: http://www.jhipster.tech/documentation-archive/v4.13.2/doing-api-first-development/
